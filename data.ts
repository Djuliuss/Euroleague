...
export const players: Player[] = [
  ...
  { name: "Jean Montero", team: 16 },
  { name: "Chris Jones", team: 16 },
  { name: "Semi Ojeleye", team: 16 },
  { name: "Jaime Pradilla", team: 16 },
  { name: "Matt Costello", team: 16 },
  { name: "Amida Brimah", team: 16 },
  { name: "Josep Puerto", team: 16 },
  { name: "Brancou Badio", team: 16 },
  { name: "Nate Sestina", team: 16 },
  { name: "Xabi López-Arostegui", team: 16 },
  { name: "Tyson Carter", team: 17 },
  { name: "Kendrick Perry", team: 17 },
  { name: "Kameron Taylor", team: 17 },
  { name: "Dylan Osetkowski", team: 17 },
  { name: "Tyson Pérez", team: 17 },
  { name: "David Kravish", team: 17 },
  { name: "Alberto Díaz", team: 17 },
  { name: "Killian Tillie", team: 17 },
  { name: "Tyler Kalinoski", team: 17 },
  { name: "Nihad Djedovic", team: 17 },
];
